...
import { PasswordInput } from '@/feature/auth/components/password-input';
import { PasswordStrengthIndicator } from '@/feature/auth/components/password-strength-indicator';
import { VerifyEmail } from '@/feature/auth/components/verify-email';
import {
  signUp,
  googleSignIn,
  githubSignIn,
} from '@/feature/auth/lib/auth-client';
import { getPasswordStrength } from '@/feature/auth/lib/password';
